...
export default function AppointmentForm() {
  ...
  const inputClasses =
    "w-full p-3   bg-white text-slate-700 border border-slate-200 focus:border-green-400 focus:ring-2 focus:ring-green-100 outline-none text-sm transition-all duration-300 hover:border-slate-300";

  const labelClasses =
    "flex items-center text-sm font-medium text-slate-600 mb-2";
      ...
      <div className="bg-white text-slate-700 shadow-lg rounded-xl p-8 w-full max-w-xl border border-slate-100 transition-all duration-500 hover:shadow-xl">
        <div className="mb-8 relative overflow-hidden">
          ...
          <div className="flex items-center p-4 bg-green-50 rounded-xl border border-green-100 mb-6 transform transition-all duration-300 hover:translate-y-1 hover:shadow-md">
            <div className="flex-shrink-0 bg-green-100 p-3   mr-4">
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-50 border border-red-100   text-sm text-red-500 flex items-start space-x-2 animate-fade-in">
        ...
        {!success ? (
          <div className="space-y-5 transition-all duration-300">
            ...
            <button
              ...
              className="w-full mt-4 bg-green-500 hover:bg-green-600 text-white py-4   text-sm font-medium transition-all duration-300 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 group"
            >
              {isSubmitting ? (
                <>
                  <svg
        ...
        <div className="mt-6 pt-6 border-t border-slate-100 text-xs text-slate-400 text-center">
          By booking an appointment, you agree to our terms of service and
          privacy policy.
        </div>
      </div>
    </div>
