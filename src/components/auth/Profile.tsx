...
export function AuthProfile() {
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-3   text-left hover:bg-red-50 transition-colors group"
          >
  ...
  //           You don't have any bookings at the moment. When you book a service,
  //           it will appear here.
  //         </p>
  //       </div>
  //     ) : (
