...
export const companyData: Record<string, ServicePage> = {
  'about': {
    ...
    description: "Leading the future of cybersecurity with innovative solutions and expert services",
    features: [
      {
        title: "Our Mission",
        description: "To secure and protect organizations in an ever-evolving digital landscape"
      },
      {
        title: "Our Vision",
        description: "To be the global leader in innovative cybersecurity solutions"
      },
      {
        title: "Our Values",
  ...
  'careers': {
    ...
    description: "Join our team of cybersecurity experts and shape the future of digital security",
    features: [
      {
